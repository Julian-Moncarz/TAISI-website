  ...
  return (
    <main>
      <section className="max-w-[1200px] mx-auto px-5 sm:px-8 pt-10 sm:pt-14 md:pt-20 pb-16 md:pb-24">
        ...
        <div className="text-[17px] sm:text-[19px] leading-[1.7] text-text space-y-4 max-w-[760px]">
          <p>
        ...
        <ul className="text-[17px] sm:text-[19px] leading-[1.7] text-text space-y-3 pl-0 list-none max-w-[760px]">
