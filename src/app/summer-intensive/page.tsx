    ...
    <main>
      <section className="max-w-[1200px] mx-auto px-5 sm:px-8 pt-10 sm:pt-14 md:pt-20 pb-16 md:pb-24">
        ...
        <div className="space-y-4 text-[17px] sm:text-[19px] leading-[1.7] text-text max-w-[800px]">
          <p>
            A program for ambitious students who want to understand the hardest problems in AI safety. 5–8 <RoughNotation type="underline" color="#D94F30" strokeWidth={2} order={1}>exceptional peers</RoughNotation> per cohort.
          </p>
          <p>
          ...
          <p className="text-text">
            One Saturday or Sunday a week, four weeks (compatible with internships and research). Cohorts monthly May&ndash;August. Hosted at <a href="https://www.trajectorylabs.org/" target="_blank" rel="noopener noreferrer" className="underline hover:text-accent transition-colors">Trajectory Labs</a>, a modern AI safety research hub on Adelaide Street, Toronto. <strong>Applications close April 5th.</strong>
          </p>
          <p className="text-text">
